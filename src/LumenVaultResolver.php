...
/**
 * Default implementation of VaultResolverInterface.
 *
 * Maintains in-memory indexes for vault lookup by slug, endpoint URL and host.
 * Can populate vaults from a remote registry endpoint returning JSON.
 */
final class LumenVaultResolver implements VaultResolverInterface
{
    ...
    /**
     * @param ClientInterface|null $httpClient Optional HTTP client used for registry fetches
     */
    ...
    /**
     * Register a vault in the resolver indexes.
     *
     * @param Vault $vault
     * @return Vault
     */
    ...
    /**
     * Convenience helper to construct and register a custom vault.
     *
     * @param string $slug
    ...
    /**
     * Resolve a vault for a given URL.
     *
     * The URL may be an exact endpoint match, a URL under the endpoint's path,
     * or share the same host (and optional port) as a registered vault.
     *
     * @param string $url
     * @return Vault
     */
    ...
    /**
     * Load vault definitions from a remote registry endpoint and register them.
     *
     * The registry must return JSON with a top-level "data" array of vault definitions.
     *
    ...
    /**
     * Get all registered vaults keyed by slug.
     *
    ...
    /**
     * Normalize an endpoint URL for stable comparisons.
     */
    ...
    /**
     * Extract a normalized host[:port] from a URL for host-based lookup.
     */
